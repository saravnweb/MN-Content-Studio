...
export default function RoleSelector() {
  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 w-full max-w-[420px]">
      ...
      {/* Creator card */}
      <div
        className="group relative bg-gray-900 border border-gray-700/50 dark:border-gray-800/60 hover:border-indigo-500/60 rounded-2xl p-4 flex flex-col items-center text-center transition-all duration-300 hover:shadow-xl hover:shadow-indigo-600/10 backdrop-blur-sm shadow-sm"
      >
        ...
        <button
          ...
          disabled={loading}
          className="flex flex-col items-center w-full active:scale-[0.98] transition-transform disabled:opacity-60"
        >
          {/* Icon — decorative */}
      ...
      {/* Brand card */}
      <div
        className="group relative bg-gray-900 border border-gray-700/50 dark:border-gray-800/60 hover:border-pink-500/60 rounded-2xl p-4 flex flex-col items-center text-center transition-all duration-300 hover:shadow-xl hover:shadow-pink-500/10 backdrop-blur-sm shadow-sm"
      >
        {/* Top accent line on hover — decorative */}
