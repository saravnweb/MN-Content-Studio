  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 w-full max-w-md">
      ...
      <button
        ...
        disabled={loading}
        className="group relative bg-gray-900 border border-gray-700/50 dark:border-gray-800/60 hover:border-indigo-500/60 rounded-2xl p-5 flex flex-col items-center text-center transition-all duration-300 hover:shadow-xl hover:shadow-indigo-600/10 active:scale-[0.98] disabled:opacity-60 backdrop-blur-sm shadow-sm"
      >
      ...
      <Link
        href="/brands/signup"
        className="group relative bg-gray-900 border border-gray-700/50 dark:border-gray-800/60 hover:border-pink-500/60 rounded-2xl p-5 flex flex-col items-center text-center transition-all duration-300 hover:shadow-xl hover:shadow-pink-500/10 active:scale-[0.98] backdrop-blur-sm shadow-sm"
      >
        {/* Top accent line on hover — decorative */}
        ...
        <div className="mt-4 w-full flex justify-center" aria-hidden="true">
          <div className="flex items-center gap-2 bg-gradient-to-r from-pink-600 to-rose-600 hover:from-pink-500 hover:to-rose-500 rounded-full px-4 py-2 w-full justify-center transition-all duration-200 shadow-sm">
