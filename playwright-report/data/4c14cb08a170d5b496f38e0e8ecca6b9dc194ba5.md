...
- Name: auth-redirects.spec.ts >> Protected route redirects (unauthenticated) >> /admin/creators redirects to /admin-login
- Location: tests\e2e\auth-redirects.spec.ts:38:9
...
Call log:
  - navigating to "http://localhost:3000/admin/creators", waiting until "load"
