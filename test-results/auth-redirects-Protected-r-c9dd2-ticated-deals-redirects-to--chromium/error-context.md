...
- Name: auth-redirects.spec.ts >> Protected route redirects (unauthenticated) >> /deals redirects to /
- Location: tests\e2e\auth-redirects.spec.ts:19:9

# Error details

```
Error: page.goto: net::ERR_INSUFFICIENT_RESOURCES at http://localhost:3000/deals
Call log:
